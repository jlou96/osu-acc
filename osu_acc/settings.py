"""
Django settings for osu_acc project.
...
WSGI_APPLICATION = 'osu_acc.wsgi.application'


# Database
# https://docs.djangoproject.com/en/2.1/ref/settings/#databasesa
